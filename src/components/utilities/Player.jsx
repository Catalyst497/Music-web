...
export default function Player({ props }) {
  ...
  return (
		<footer className="flex items-center music-player- fixed bottom-0 inset-x-0 h-[5rem] md:h-[8rem] border-t-[1px] z-20 border-t-secondary-color bg-black/10 backdrop-blur-sm">
			<div className="flex justify-between md:justify-start w-[85%] mx-auto gap-6">
				<div className="flex gap-4 md:w-[20%]">
					<img
						...
						alt=""
						className="rounded-md md:rounded-2xl h-10 w-10 md:h-14 md:w-14"
					/>
